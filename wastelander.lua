        ...
        if IsPedInAnyVehicle(playerPed, false) then
            ...
            if GetEntityModel(vehicle) == GetHashKey("wastelander") then
                ...
                if not DoesEntityExist(prop2) then
                    ...
                    AttachEntityToEntity(prop2, vehicle, boneIndex1, 0.0, -2.4, 0.8, 0.0, 0.0, 0.0, true, true, true, true, 1, true)
                end
                ]]
...
--2nd Rangee
                ...
                --[[ -- Crée et positionne le prop prop_jerrycan_01a
                if not DoesEntityExist(prop54) then
                    prop54 = CreateObject(GetHashKey("prop_wall_light_05c"), 0.0, 0.0, 0.0, true, true, true)
                    AttachEntityToEntity(prop54, vehicle, boneIndex1, 0.1, -2.5, 3.25, 0.0, 0.0, 90.0, true, true, false, true, 1, true)
                end    
                -- Crée et positionne le prop prop_jerrycan_01a
                if not DoesEntityExist(prop55) then
                    prop55 = CreateObject(GetHashKey("prop_wall_light_05c"), 0.0, 0.0, 0.0, true, true, true)
                    AttachEntityToEntity(prop55, vehicle, boneIndex1, 0.1, 0.0, 3.25, 0.0, 0.0, 90.0, true, true, false, true, 1, true)
                end   ]]
                -- Crée et positionne le prop prop_jerrycan_01a
